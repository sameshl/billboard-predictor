...
#score_l = []
#label_l = []
with open('/home/samesh/PycharmProjects/ml_project/final_raw_datasets/not_billboards_2.csv') as csv_file:
...
with open('spotify_notbillboards_1.csv', mode='w') as spotify_features:
